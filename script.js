...
const navitems = document.getElementById("features");
const navitem01 = document.getElementById("features01");
...
navitems.addEventListener("click", () => {
    ...
    Drawer2.classList.add("hidden")
})
navitem01.addEventListener("click", () => {
    Drawer2.classList.toggle("hidden")
